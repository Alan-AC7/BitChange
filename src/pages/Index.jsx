      ...
      <div className='p-5'>
        ...
        <div className="hero h-auto w-full bg-base-200 rounded-lg">
          <div className="hero-content flex-col lg:flex-row">
            <figure className="max-w-full lg:max-w-sm rounded-lg shadow-2xl overflow-hidden">
              <img
      ...
      <div className='p-5'>
        <div className="hero h-auto w-full bg-base-200 rounded-lg">
          <div className="hero-content flex-col lg:flex-row-reverse">
            <img src="https://cdn.images.express.co.uk/img/dynamic/23/750x445/1136210.jpg" className="max-w-full lg:max-w-sm rounded-lg shadow-2xl" />
            <div>
