...
<div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="mb-4 flex items-center justify-between gap-8 sm:mb-8 md:mb-12">
        <div class="flex items-center gap-12">
            <h2 class="text-2xl font-bold text-gray-800 lg:text-3xl dark:text-white">{t('gallery.gallery1')}</h2>
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
        ...
        <a href="#"
            ...
            <span class="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">{t('gallery.gallery2')}</span>
        </a>
        ...
        <a href="#"
            ...
            <span class="relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg">{t('gallery.gallery3')}</span>
        </a>
